...
VALUES(1, 'hong', '123','홍길동','01011112222','jhk7764@naver.com','2024-01-01','1234','울산남구','1길','남','USER');
...
INSERT INTO studyroom_seat VALUES (60, 'OFF', 1, null, 2, 2);
...
SELECT MEMBER_ID
	,CONCAT(SUBSTR(MEMBER_TEL, 1 , 3), '-',SUBSTR(MEMBER_TEL, 4 , 4), SUBSTR(MEMBER_TEL, 8))
  ,MEMBER_EMAIL
